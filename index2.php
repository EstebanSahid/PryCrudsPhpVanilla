                    ...
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav  ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="./Vistas/planifView.php">Planificacion</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="./Vistas/evaluacionView.php">Evaluación</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="img-box">
                                            <div>
                                                <img src="images/muyulema.jpg" alt="" class="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="detail-box">
                                            <div><h2>Instituto Tecnológico Universitario <span>"Cordillera"</span></h2></div>
                                            <br>
                                            <br>
                                            <div>
                                                <h1>
