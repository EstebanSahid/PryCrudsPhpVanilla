...
est.*,
ti.ti_texto, 
CONCAT(est.est_primerApellido,' ', est.est_segundoApellido, ' ', est.est_primerNombre) as estudiante
FROM estudiante est
INNER JOIN tipoidentificacion ti
ON est.ti_id = ti.ti_id
WHERE est.est_estado = 1");
$index -> execute();
$listaAlumnos = $index->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="row pt-4">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    foreach($listaAlumnos as $Alumno){?>
                        <tr>
                            <td class="text-center align-middle"><?= $Alumno['estudiante']; ?></td>
                            <td class="text-center align-middle"><?= $Alumno['ti_texto']; ?></td>
                            <td class="text-center align-middle"><?= $Alumno['est_numIdentificacion']; ?></td>
                            <td class="text-center align-middle"><?= $Alumno['est_correo']; ?></td>
                            <td class="text-center align-middle"><?= $Alumno['est_direccion']; ?></td>
                            <td class="text-center align-middle"><?= $Alumno['est_telefono']; ?></td>
                            <td class="align-middle"> 
                                <div class="d-flex justify-content-center contact_crud">
                                    <button class="editarAlumnoBtn btn btn-primary mr-2"
                                            data-idti="<?= $Alumno["ti_id"]; ?>"
                                            data-id="<?= $Alumno['est_id'];?>"
                                            data-pnombre="<?= $Alumno['est_primerNombre'];?>"
                                            data-snombre="<?= $Alumno['est_segundoNombre'];?>"
                                            data-papellido="<?= $Alumno['est_primerApellido'];?>"
                                            data-sapellido="<?= $Alumno['est_segundoApellido'];?>"
                                            data-correo="<?= $Alumno['est_correo']; ?>"
                                            data-ruc="<?= $Alumno['est_numIdentificacion'];?>"
                                            data-telef="<?= $Alumno['est_telefono'];?>"
                                            data-dir="<?= $Alumno['est_direccion'];?>"
                                            >
                                        Editar
                                    </button>
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../Controladores/AlumnoController.php" method="post">
                            <div class="row">
                                <input type="hidden" name="txt_idAlumno" id="txt_idAlumno">
                                <div class="col-3">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="txt_pApellido" placeholder="" name="txt_pApellido" required>
                                        <label for="txt_pApellido">Primer Apellido</label>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.editarAlumnoBtn').click(function(){
                    ...
                    $('#modalEdit #txt_idAlumno').val(idAlumno);
                ...
                $('.eliminarEmpresaBtn').click(function(){
                    var idAlumno = $(this).data('id');
                    console.log(idAlumno);
                    $('#modalDelete #txt_id').val(idAlumno);
